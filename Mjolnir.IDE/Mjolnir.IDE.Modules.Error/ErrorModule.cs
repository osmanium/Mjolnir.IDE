    ...
    public class ErrorModule : IModule
    {
        ...
        private void LoadToolbar()
        {
            ...
            var errorToggleButton = new MenuItemViewModel(
                             "_Error", ErrorCountText(), 3, new BitmapImage(new Uri(@"pack://application:,,,/Mjolnir.IDE.Modules.Error;component/Assets/Error.png")),
            ...
            var warningToggleButton = new MenuItemViewModel(
                             "_Warning", WarningCountText(), 3, new BitmapImage(new Uri(@"pack://application:,,,/Mjolnir.IDE.Modules.Error;component/Assets/Warning.png")),
            ...
            var informationToggleButton = new MenuItemViewModel(
                             "_Information", InformationCountText(), 3, new BitmapImage(new Uri(@"pack://application:,,,/Mjolnir.IDE.Modules.Error;component/Assets/Message.png")),
